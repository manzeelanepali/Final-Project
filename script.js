...
function gameOver(arr , index) {
    ...
    // debugger
      ...
      highestScore.innerText = score
        ...
        console.log('highestScore',highestScore,highestScore.innerHTML, highestScore.innerText )
        highestScore.innerHTML = highScore
        console.log('highestScore',highestScore,highestScore.innerHTML, highestScore.innerText )
...
// whem the projecticles goes offscreen it vanishes 
